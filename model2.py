...
class IntegerLiteral(Expr):
	value: int = 0
	lineno: int = 0
	type: Optional[Type] = field(default_factory=lambda: INT)
...
class BooleanLiteral(Expr):
	value: bool = False
	lineno: int = 0
	type: Optional[Type] = field(default_factory=lambda: BOOL)
...
class CharLiteral(Expr):
	value: str = "\0"
	lineno: int = 0
	type: Optional[Type] = field(default_factory=lambda: CHAR)
...
class StringLiteral(Expr):
	value: str = ""
	lineno: int = 0
	type: Optional[Type] = field(default_factory=lambda: STRING)
